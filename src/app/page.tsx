        ...
        <div className="flex flex-row gap-10">
          ...
          >
            <ScanLine
              ...
              strokeWidth={1.2}
            />
            <h1 className="text-2xl tracking-widest text-secondary">Scan Qr</h1>
          </Link>
          <Link
            href="/q"
            className="w-48 aspect-square bg-white rounded-xl shadow-md flex flex-col items-center justify-center gap-5 p-5"
          >
            <ShieldUser
              className="text-primary w-full h-full"
              strokeWidth={1.2}
