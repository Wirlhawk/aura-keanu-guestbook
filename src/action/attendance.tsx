...
export const removeAttendanceById = async (attendanceId: string) => {
  try {
    const supabase = await createClient();
...
export const getAllAttendance = async () => {
  try {
    ...
    const { data, error } = await supabase.rpc("get_attendance_with_guests");

    if (error) {
      console.error("Error fetching guest with attendance:", error);
      return [];
    }
